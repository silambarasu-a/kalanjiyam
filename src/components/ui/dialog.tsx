  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[min(28rem,calc(100%-2rem))] max-h-[90vh] -translate-x-1/2 -translate-y-1/2 flex flex-col rounded-2xl bg-popover text-sm text-popover-foreground ring-1 ring-border shadow-(--shadow-popover) duration-100 outline-none overflow-hidden data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
