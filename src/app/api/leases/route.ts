    ...
    return NextResponse.json({
      leases: leases.map((l) => {
        ...
        return {
          ...
          active: l.active,
          notes: l.notes,
          lessor: l.lessorMember ?? (l.lessorName ? { id: null, name: l.lessorName } : null),
          lessee: l.lesseeMember ?? (l.lesseeName ? { id: null, name: l.lesseeName } : null),
    ...
    const lease = await prisma.$transaction(async (tx) => {
      const l = await tx.lease.create({
        data: {
          ...
          lessorMemberId: data.lessorMemberId ?? null,
          lessorName: data.lessorName ?? null,
          lesseeMemberId: data.lesseeMemberId ?? null,
