import { escapeHtml, renderLayout, renderSoftPanel } from "./_layout";
...
export function passwordChangedTemplate({ name, changedAt, appUrl }: Args) {
  ...
  const body = `
    ...
    `)}
    <p style="margin:16px 0 0 0;font-size:13px;color:#64748B;">If this wasn't you, reset your password immediately and sign out of any active sessions.</p>
  `;
